# Adapted from MiSLAS (MIT License) – https://github.com/dvlab-research/MiSLAS
...
class IMBALANCECIFAR100(torchvision.datasets.CIFAR100):
    ...
    def __init__(self, root, imb_type='exp', imb_factor=100, rand_number=0, train=True,
...
class CIFAR100_LT(object):
    def __init__(self, distributed, root='./data/cifar100', imb_type='exp',
                    imb_factor=100, batch_size=128, num_works=40):
